...
#             functions=[
#                 # The retriever tool
#                 format_tool_to_openai_function(self.toolkit.tools), 
#                 # Response schema
...
#         )
        ...
        executor = load_agent_executor(model, self.toolkit.tools, verbose=True)
        self.agent_executor = PlanAndExecute(planner=planner, executor=executor, verbose=True)
